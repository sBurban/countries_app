...
const buttonWithStyles = (
  ElemParam: React.ComponentType<ButtonProps>,
  name = "default"
) => {
  const colors = [
    {
  ...
  const { backgroundColor, color }: ColorStyle =
  ...
  return (props: ButtonProps) => (
    <ElemParam {...props} style={buttonStyles}></ElemParam>
  );
};

const NewButton = buttonWithStyles(Button, "warning");

export { Button, buttonWithStyles, NewButton };
